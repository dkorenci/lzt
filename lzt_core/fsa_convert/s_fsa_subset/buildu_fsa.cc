...
extern tree_index   primary_index;
extern tree_index   secondary_index;
...
// ADDED IN HOPE THAN NOT INITIALIZING INDEXES IS THE CAUSE OF THE BUG
  primary_index.down.leaf = NULL; primary_index.allocated = primary_index.counter = 0;
  secondary_index.down.leaf = NULL; secondary_index.allocated = secondary_index.counter = 0;
